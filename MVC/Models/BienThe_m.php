...
class BienThe_m extends connectDB
{
    ...
    {
        $sql = "INSERT INTO bien_the VALUES ('$ma_bien_the', '$ma_san_pham', '$ten_bien_the', '$mau_sac', '$ram', '$dung_luong', '$gia', '$so_luong_kho')";
    ...
    function BienThe_update($ma_bien_the, $ma_san_pham, $ten_bien_the, $mau_sac, $ram, $dung_luong, $gia, $so_luong_kho)
    {
        $sql = "UPDATE bien_the SET ma_san_pham = '$ma_san_pham', ten_bien_the = '$ten_bien_the',
                ...
                gia = '$gia', so_luong_kho = '$so_luong_kho' WHERE ma_bien_the = '$ma_bien_the'";
        return mysqli_query($this->con, $sql);
    }
    ...
    // Hàm lấy tất cả biến thể với thông tin sản phẩm
