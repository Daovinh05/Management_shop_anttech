...
{
    // Hàm thêm biến thể
    function bien_the_ins($ma_bien_the, $ma_san_pham, $ten_bien_the, $img_bien_the, $mau_sac, $ram, $dung_luong, $gia, $so_luong_kho)
    {
        ...
        $img_bien_the = mysqli_real_escape_string($this->con, $img_bien_the);
        ...
        $sql = "INSERT INTO bien_the (ma_bien_the, ma_san_pham, ten_bien_the, img_bien_the, mau_sac, ram, dung_luong, gia, so_luong_kho)
                VALUES ('$ma_bien_the', '$ma_san_pham', '$ten_bien_the', '$img_bien_the', '$mau_sac', '$ram', '$dung_luong', '$gia', '$so_luong_kho')";
    ...
    // Hàm sửa biến thể
    function BienThe_update($ma_bien_the, $ma_san_pham, $ten_bien_the, $img_bien_the, $mau_sac, $ram, $dung_luong, $gia, $so_luong_kho)
    {
        $ma_bien_the = mysqli_real_escape_string($this->con, $ma_bien_the);
        $ma_san_pham = mysqli_real_escape_string($this->con, $ma_san_pham);
        $ten_bien_the = mysqli_real_escape_string($this->con, $ten_bien_the);
        ...
        $sql = "UPDATE bien_the SET ma_san_pham = '$ma_san_pham', ten_bien_the = '$ten_bien_the',
                img_bien_the = '$img_bien_the', mau_sac = '$mau_sac', ram = '$ram', dung_luong = '$dung_luong',
    ...
    function BienThe_delete($ma_bien_the)
    {
        ...
        // Xóa hình ảnh liên quan trước khi xóa biến thể
        ...
        if ($result && $row = mysqli_fetch_assoc($result)) {
            $imagePath = $_SERVER['DOCUMENT_ROOT'] . '/Banhang/Public/Pictures/bien_the/' . $row['img_bien_the'];
