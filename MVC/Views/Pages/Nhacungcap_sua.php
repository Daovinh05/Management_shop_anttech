...
<body>
    ...
    <div class="card">
        ...
        <form id="updateSupplierForm" method="post" action="<?php echo BASE_URL; ?>Nhacungcap/update" enctype="multipart/form-data">
            <div>
            ...
            <div>
                ...
                <input type="tel" id="phone" name="txtSodienthoai" placeholder="VD: 0912345678" required
                    value="<?php echo isset($data['dien_thoai']) ? htmlspecialchars($data['dien_thoai']) : '' ?>" maxlength="10"
                    pattern="[0-9]{10}" title="Vui lòng nhập đúng 10 chữ số điện thoại" />
            </div>

            <div class="full">
                <label for="address">Địa chỉ</label>
                <input type="text" name="txtDiachi" placeholder="Nhập địa chỉ nhà cung cấp"
                    value="<?php echo isset($data['dia_chi']) ? htmlspecialchars($data['dia_chi']) : '' ?>" />
            </div>
