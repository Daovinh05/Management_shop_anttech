...
<body>
    ...
    <div class="card">
        ...
        <form method="post" action="http://localhost/Banhang/Danhgia/Timkiem" class="form-search"
            ...
            <div class="actions" style="margin-top:0;">
                <button type="submit" class="btn-primary" name="btnTim"><i class="fa-solid fa-search"></i> Tìm
                    kiếm</button>
                <a href="http://localhost/Banhang/Danhgia/danhsach" class="btn-ghost">Làm mới</a>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td style="text-align:right">
                                        <a href="http://localhost/Banhang/Danhgia/sua/<?php echo urlencode($row['ma_danh_gia']) ?>"><button
                                                class="btn-edit">✏️
                                                Sửa</button></a>
                                        <a href="http://localhost/Banhang/Danhgia/xoa/<?php echo urlencode($row['ma_danh_gia']) ?>"
