...
<body>
    <div class="wrap">
        <div class="card">
            ...
            <form id="promotionImportForm" method="POST" action="#" enctype="multipart/form-data">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" id="importPromotionBtn" name="btnNhap" class="btn btn-primary" style="min-width: 150px;">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('promotionImportForm');
            const submitBtn = document.getElementById('importPromotionBtn');
            ...
            form.addEventListener('submit', function(event) {
                ...
                fetch(BASE_URL + 'Api/Khuyenmai/import', {
                    method: 'POST',
                    body: formData
                })
                ...
                .then(function(result) {
                    ...
                    if (!result.ok || !data.success) {
                        ...
                        const failedPreview = failedRows.slice(0, 5).map(function(item) {
                            return 'Dòng ' + item.row + ' (' + (item.ma_khuyen_mai || 'N/A') + '): ' + item.reason;
                        }).join('\n');

                        throw new Error((data.message || ('Import thất bại (HTTP ' + result.status + ')')) + (failedPreview ? ('\n' + failedPreview) : ''));
                    }

                    alert('Import khuyến mãi thành công qua REST API.');
                })
